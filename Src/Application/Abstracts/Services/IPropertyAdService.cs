...
{
    Task<bool> CreatePropertyAdAsync(CreatePropertyAdRequest request, List<MediaUploadInput>? media, CancellationToken ct=default);
    ...
    Task<bool> UpdatePropertyAdAsync(
    int id,
